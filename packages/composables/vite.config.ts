...
export default defineConfig({
  ...
  build: {
    ...
    rollupOptions: {
      ...
      // 注意: '@octopus/client-common/*' のサブパスを external として扱っているため、
      //       Rollup の globals に個別サブパスのマッピングを追加しておく。
      external: [
        "vue",
        "@octopus/client-common",
        /^@octopus\/client-common\//,
        "packages/common-lib",
        /^packages\/common-lib\//,
      ],
      output: {
        globals: {
          ...
          "@octopus/client-common": "commonLib",
          // サブパスを個別にマッピングしておくと、"No name was provided for external module ..."
          // の警告を抑制できる（全て同じ global オブジェクトを参照する想定）。
          "@octopus/client-common/audio/audio-service": "commonLib",
          "@octopus/client-common/events/event-bus": "commonLib",
          "@octopus/client-common/storage/local-storage-service": "commonLib",
        },
      },
    },
  },
