...
// Behavioral counterpart of `AppEventData`: constructed only by
// `AppEventService`, never persisted directly (persistence works with plain
// `AppEventData`).
export interface AppEvent {
  readonly id: string;
  readonly type: AppEventData["type"];
