...
export const sharedAliases: Record<string, string> = {
  "@common-lib": path.resolve(__dirname, "client/packages/common-lib/src"),
  "@shared-composables": path.resolve(
    __dirname,
    "client/packages/shared-composables/src"
  ),
  "@presenters/content-deck": path.resolve(
    __dirname,
    "client/presenters/content-deck/src"
  ),
  "presenters/content-deck": path.resolve(
    __dirname,
    "client/presenters/content-deck/src"
  ),
  presenters: path.resolve(__dirname, "client/presenters"),
  "packages/common-lib": path.resolve(
    __dirname,
    "client/packages/common-lib/src"
  ),
  "games/jackpot-game": path.resolve(
    __dirname,
    "client/games/jackpot-game/src"
  ),
  "games/card-game": path.resolve(__dirname, "client/games/card-game/src"),
  "games/quiz-game": path.resolve(__dirname, "client/games/quiz-game/src"),
};
