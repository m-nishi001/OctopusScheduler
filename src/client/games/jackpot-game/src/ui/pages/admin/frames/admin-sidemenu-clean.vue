    ...
    <aside class="admin-sidebar">
        <nav>
            <ul>
                ...
                <li class="submenu">
                    <div class="menu-link submenu-toggle" :class="{ 'parent-active': parentActive }"
                        @click="toggleScreensSubmenu" role="button" tabindex="0" @keydown="onToggleKey">
...
.submenu-list {
    ...
    margin: 4px 0 0 18px;
    padding: 4px 0 0 0;
    /* left indent keeps icons aligned */
    overflow: hidden;
}
