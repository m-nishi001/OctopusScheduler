<template>
  <div class="admin-section">
    ...
    <PrizeAddDialog v-if="showAddModal" :show="showAddModal" :image-assets="imageAssets" :audio-assets="audioAssets" @close="showAddModal = false" @refresh="fetchPrizes" />
    <PrizeEditDialog v-if="editPrizeData" :prize="editPrizeData" :image-assets="imageAssets" :audio-assets="audioAssets" :object-url-map="objectUrlMap" @close="editPrizeData = null" @refresh="fetchPrizes" />
