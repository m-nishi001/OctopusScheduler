...
.kakuhen-text {
  ...
  font-size: 18vw; /* very large, scales with viewport */
  line-height: 1;
...
.kakuhen-text .char { display: inline-block; opacity: 0; transform: scale(0.6); }
.kakuhen-text .char-1 {
...
@keyframes charPunch {
  ...
  40% { transform: scale(2.0); opacity: 1; }
...
@media (prefers-reduced-motion: reduce) {
  .kakuhen-dim { animation: none; opacity: 0.72; }
  .kakuhen-text .char { animation: none; opacity: 1; transform: none; }
  .kakuhen-ripple { animation: none; opacity: 0; }
}
</style>