...
export class MemberRepository {
  ...
  async fetchMembers(): Promise<Member[]> {
    ...
    return new Promise((resolve, reject) => {
      this.gasService
        .createCall<{ members: Member[] }>('JackpotApiService.getMembers')
  ...
  async saveMember(member: Member): Promise<void> {
    ...
    return new Promise((resolve, reject) => {
      this.gasService
        .createCall<void>('JackpotApiService.saveMember', member)
  ...
  async updateMember(member: Member): Promise<void> {
    ...
    return new Promise((resolve, reject) => {
      this.gasService
        .createCall<void>('JackpotApiService.updateMember', member)
        .withSuccessed(() => resolve())
        .withFailuered((msg: string) => reject(new Error(msg)))
        .invoke();
    });
  ...
  async deleteMember(memberId: string): Promise<void> {
    ...
    return new Promise((resolve, reject) => {
      this.gasService
        .createCall<void>('JackpotApiService.deleteMember', { memberId })
        .withSuccessed(() => resolve())
        .withFailuered((msg: string) => reject(new Error(msg)))
        .invoke();
    });
