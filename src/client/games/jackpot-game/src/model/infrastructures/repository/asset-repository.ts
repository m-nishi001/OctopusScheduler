...
export class AssetRepository {
  ...
  async fetchAssets(): Promise<Asset[]> {
    ...
    return new Promise((resolve, reject) => {
      this.gasService
        .createCall<{ assets: Asset[] }>('JackpotApiService.getAssets')
  ...
  async saveAsset(asset: Asset): Promise<void> {
    ...
    return new Promise((resolve, reject) => {
      this.gasService
        .createCall<void>('JackpotApiService.saveAsset', asset)
  ...
  async updateAsset(asset: Asset): Promise<void> {
    ...
    return new Promise((resolve, reject) => {
      this.gasService
        .createCall<void>('JackpotApiService.updateAsset', asset)
        .withSuccessed(() => resolve())
        .withFailuered((msg: string) => reject(new Error(msg)))
        .invoke();
    });
  ...
  async deleteAsset(assetId: string): Promise<void> {
    ...
    return new Promise((resolve, reject) => {
      this.gasService
        .createCall<void>('JackpotApiService.deleteAsset', { assetId })
        .withSuccessed(() => resolve())
        .withFailuered((msg: string) => reject(new Error(msg)))
        .invoke();
    });
