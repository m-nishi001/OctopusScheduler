...
import { ScheduleEventRepository } from "../../infrastructures/schedule-event/schedule-event-repository";

export class ScheduleEventService {
  private _repo: IScheduleEventRepository;

  constructor(scheduleEventRepository?: IScheduleEventRepository) {
    this._repo = scheduleEventRepository ?? new ScheduleEventRepository();
  }
