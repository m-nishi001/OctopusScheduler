...
import type { Audio } from '../domains/assets/audio/entity/audio';
import type { Image } from '../domains/assets/image/entity/image';
import type { Movie } from '../domains/assets/movie/entity/movie';
